...
⚠️ This package is **abandoned** and no longer maintained. The author suggests using the **[rinvex/languages](https://github.com/rinvex/languages)** package instead. ⚠️
...
> **Notes:**
> - **Rinvex Language** is framework-agnostic, so it's compatible with any PHP framework whatsoever without any dependencies at all, except for the PHP version itself **^7.1.3**. Awesome, huh? :smiley:
